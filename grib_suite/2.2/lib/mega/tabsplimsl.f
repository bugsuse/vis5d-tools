...
c Meteorologico Regionale (SMR), Viale Silvani 6, 40122 Bologna, Italia
	...
	SUBROUTINE TABSPLIMSL (DATI,N,N1,N2,MX,MN,MD,IN,IER)

COMSTART TABSPLIMSL
C	SUBROUTINE TABSPLIMSL (DATI,N,N1,N2,MX,MN,MD,IN,IER)
C
...
COMEND
	...
	INTEGER*2 DATI(N)
	REAL X(NMAX),Y(NMAX),MX,MN,MD,OMX,OMN
