...
c Meteorologico Regionale (SMR), Viale Silvani 6, 40122 Bologna, Italia
	...
	FUNCTION RIPORTAPRES(P,T,HHPOZ)	

COMSTART RIPORTAPRES
C	FUNCTION RIPORTAPRES(P,T,HHPOZ)	
C	
C	Riporta la pressione al livello del mare secondo le specifiche
...
C	P0=P*10.**(HHPOZ/(18429.1+67.53*TM+0.003*HHPOZ))
	...
	RIPORTAPRES=P0			!Pressione s.l.m.
