...
C	*******  PRECI  TEMPRS  ********
	...
	DO I=1,D5A
		IF(TEMPRS.EQ.COD5A(I).AND.PRECI.EQ.0)GOTO 15
	END DO
...
C	*******  PRECI  TEMPAS  ********
	...
	DO I=1,D5B
		IF(TEMPAS.EQ.COD5B(I).AND.PRECI.EQ.0)GOTO 16
	END DO
...
196	CONTINUE
	IF (.NOT.C_E(TATA).OR..NOT.C_E(TDTD))GOTO197

	DO I=1,D6H
		IF(TEMPRS.EQ.COD6H(I).AND.TATA-TDTD.GT.10)GOTO 21
	END DO

197	IF (.NOT.C_E(UMID))GOTO210
	DO I=1,D6H
...
C	*******  CL  HH  CM ********
	...
	IF (.NOT.C_E(HH).AND..NOT.C_E(CL).AND..NOT.C_E(CM))GOTO 610
...
C	*************  CM  NH  CL  **************
	...
	IF (.NOT.C_E(CM).AND..NOT.C_E(NH).AND..NOT.C_E(CL))GOTO 640
...
C	*******  CM  HH  CL ********
	...
	IF (.NOT.C_E(HH).AND..NOT.C_E(CL).AND..NOT.C_E(CM))GOTO 620
...
C	*******  HH  NTOT ********
	...
	IF (.NOT.C_E(NTOT).AND..NOT.C_E(HH))GOTO 570
...
C	*******  HH  NH ********
	...
	IF (.NOT.C_E(HH).AND..NOT.C_E(NH))GOTO 580
...
C	*******  HH  CL CM ********
	...
	IF (.NOT.C_E(HH).AND..NOT.C_E(CL).AND..NOT.C_E(CM))GOTO 590
