...
c
c    $Date: 2005-11-28 15:43:03 +0100 (lun, 28 nov 2005) $    $Revision: 57 $
c    $Id: struct.h 57 2005-11-28 14:43:03Z cvs $
...
struct section1_type {
    ...
    gribint   dwd_luse[11];          /* DWD local use */
    gribint   dwd_version;           /* DWD local use version number */
};
...
struct section2_type {
    ...
    gribint   stretching_pole_longitude;   /* Longitude of pole of stretching 
					       in millidegrees */
    gribint   lov;           /* Line of view (longitude) (Lambert/stereo) */
    gribint   centre_flag;   /* Projection centre flag (Lambert/stereo) */
    gribint   latin1;        /* Latitude of 1st intersection */
    gribint   latin2;        /* Latitude of 2nd intersection */
    float      stretching_factor;           /* Stretching factor */
    gribint   triang_ni2;    /* DWD triangular grid */
    gribint   triang_ni3;
    gribint   triang_nd;
    gribint   triang_ni;
...
struct partgrib_filename {
  char *name;
  struct partgrib_filename *next;
};
