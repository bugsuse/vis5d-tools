...
c      $Date: 2000/04/28 12:54:33 $    $Revision: 1.9 $
c      $Id: pbutils.c,v 1.9 2000/04/28 12:54:33 lambo Exp $
...
#ifdef UNDERSCORE
void pbopen_(gribint* unit, char* name, char* mode, gribint* iret, long l1, long l2)
#else
#  ifdef _CRAY
void PBOPEN(gribint* unit, char* name, long l1, char* mode, long l2, gribint* iret)
#  else
void pbopen(gribint* unit, char* name, char* mode, gribint* iret, long l1, long l2)
#  endif
#endif
...
#  endif
#endif
(gribint* unit, gribint* offset, gribint* whence, gribint* iret)
...
#  endif
#endif
(gribint* unit, unsigned char* grib, gribint* kinlen, gribint* koutlen, gribint* iret)
